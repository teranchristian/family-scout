...
- **What it is:** concrete activities, facilities or program content that the
  family can expect—not just “playground”, “museum” or “children's centre”.
- **Age fit:** how the verified activities suit each attending child's age, and
  any area or session that only one child can use.
...
Keep option cards scannable, but prefer one or two concrete explanatory
sentences over thin labels. Distinguish dated events from venues or activities
available on ordinary opening days.
